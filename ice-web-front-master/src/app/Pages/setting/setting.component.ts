...
export class SettingComponent implements OnInit {
  ...
  constructor(private shared: SharedService, private campaignService: CampaignService, public setingservice: SettingService, public router: Router, public toast: ToastrService) {
